@if($seo)
    <meta name="title" Content="{{ isset($seo->course_title) ? $seo->course_title : $general->siteName(__($pageTitle)) }}">
    ...
    <meta name="apple-mobile-web-app-title" content="{{ isset($seo->course_title) ? $seo->course_title : $general->siteName($pageTitle) }}">
    {{--<!-- Google / Search Engine Tags -->--}}
    <meta itemprop="name" content="{{ isset($seo->course_title) ? $seo->course_title : $general->siteName($pageTitle) }}">
