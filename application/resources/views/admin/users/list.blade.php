                                ...
                                @forelse($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="@lang('Enroll in Courses')" href="{{ route('admin.users.enroll.courses', $user->id) }}"
...
@push('breadcrumb-plugins')
    <div class="d-flex flex-wrap justify-content-end">
        <a href="{{ route('admin.users.create.student') }}" class="btn btn--primary me-2">
            <i class="las la-plus"></i>@lang('Create Student')
        </a>
