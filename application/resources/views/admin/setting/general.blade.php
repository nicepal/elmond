        ...
        <div class="card">
            <div class="card-body px-4">
                <form action="" method="POST">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <h5 class="mb-3">@lang('WhatsApp Chat Settings')</h5>
                        </div>
                        <div class="col-md-6">
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                ...
                                <div class="col-md-9 col-xs-12">
                                    ...
                                    <small class="text-muted">@lang('Include country code (e.g., +91 for India)')</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label>@lang('Default Message')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <textarea class="form-control" name="whatsapp_message" rows="3" 
                                        placeholder="Hello! How can we help you?">{{$general->whatsapp_message}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="fw-bold">@lang('Enable WhatsApp Chat')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <label class="switch m-0">
                                        <input type="checkbox" class="toggle-switch" name="whatsapp_enabled" {{ 
                                            $general->whatsapp_enabled ? 'checked' : null }}>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
