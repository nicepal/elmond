    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar__menu-header">@lang('Organization Management')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.organizations.*') }}">
                    <a href="{{ route('admin.organizations.index') }}" class="nav-link ">
                        <i class="menu-icon las la-building"></i>
                        <span class="menu-title">@lang('Organizations')</span>
                    </a>
                </li>
                ...
                <li class="sidebar__menu-header">@lang('Coupon Management')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.coupons.*') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.instructor.ticket.*') }}">
                    <a href="{{ route('admin.instructor.ticket.pending') }}" class="nav-link ">
                        <i class="menu-icon las la la-life-ring"></i>
                        <span class="menu-title">@lang('Instructor Support')</span>
