        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.coupons.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="discount_type" required>
                                    <option value="percentage" {{ old('discount_type') == 'percentage' ? 'selected' : '' }}>@lang('Percentage')</option>
                                    <option value="fixed" {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>@lang('Fixed Amount')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" class="form-control" name="discount_amount" required value="{{ old('discount_amount') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text discount-type-addon">%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control" name="minimum_purchase" value="{{ old('minimum_purchase', 0) }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" name="usage_limit" value="{{ old('usage_limit') }}" placeholder="Unlimited if empty">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>@lang('Usage Limit Per User')</label>
                                <input type="number" min="0" class="form-control" name="usage_limit_per_user" value="{{ old('usage_limit_per_user') }}" placeholder="Unlimited if empty">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2-multi-select" name="applicable_courses[]" multiple>
                                    ...
                                    <option value="{{ $course->id }}" {{ (is_array(old('applicable_courses')) && in_array($course->id, old('applicable_courses'))) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_first_purchase_only" name="is_first_purchase_only" {{ old('is_first_purchase_only') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_registration_bonus" name="is_registration_bonus" {{ old('is_registration_bonus') ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn--primary btn-block">@lang('Create Coupon')</button>
                    </div>
                </form>
            </div>
        </div>
