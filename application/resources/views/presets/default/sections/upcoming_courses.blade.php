...
<section class="upcoming-courses pt-120">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-header text-center">
                    <h2 class="section-title">@lang('Upcoming Courses')</h2>
                    <p class="section-desc">@lang('Get ready for our exciting upcoming courses')</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="base-card mb-4">
                        ...
                        <div class="launch-badge upcoming">
                            <i class="fas fa-clock"></i> @lang('Coming Soon')
                        </div>
                        ...
                        <div class="content-wrap">
                            ...
                            @if($course->launch_date)
                                <p class="launch-date upcoming-date">
                                    ...
                                    @lang('Launching'): {{ $course->launch_date->format('M d, Y') }}
                                </p>
                            @endif
        ...
        <div class="text-center mt-5">
            <a href="{{ route('course') }}?launch_type=upcoming" class="btn btn--base btn-lg">
                @lang('View All Upcoming Courses') <i class="fas fa-arrow-right ms-2"></i>
            </a>
        </div>
    </div>
</section>
