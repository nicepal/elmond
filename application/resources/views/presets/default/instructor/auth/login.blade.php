            ...
            <div class="row mx-0">
                ...
                <div class="col-xl-5 col-lg-6 px-0">
                    ...
                    <div class="login-box">
                        ...
                        <form method="POST" action="{{ route('instructor.login') }}" class="verify-gcaptcha">
                            @csrf
                            ...
                            <div class="mb-4 form-group">
                                ...
                                <input class="form--control" type="password" placeholder="@lang('Enter Your Password')" name="password" id="password"
                                    requird>
                            </div>
                            <x-captcha></x-captcha>
                            <div class="login-meta mb-4 d-flex" data-wow-delay="0.5s">
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        <a href="{{ route('instructor.password.request') }}" class="forgot-password">@lang('Forgot Your Password?')</a>
                                    </div>
                                </div>
                            ...
                            <div class="social-option">
                                ...
                                @endif
                                <p>@lang('Already have an account ? ')<a href="{{ route('instructor.register') }}"> @lang('Register')</a></p>
                            </div>
                        </form>
                    </div>
                    <!-- sign in components /> -->
