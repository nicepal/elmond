                            ...
                            <div class="tab-pane fade active show" id="description" role="tabpanel">
                                <div class="description mt-3">
                                    <div class="d-flex justify-content-end" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Setup Instruction"><button type="button" class="btn btn--base btn--sm"
                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="fa-solid fa-circle-info"></i>
                                        </button></div>


                                    <form action="{{ route('instructor.zoom.store.credential') }}" method="POST">
                                        @csrf
                                        <div class="content">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input class="form--control" name="zoom_account_id"
                                                            value="{{ __(@$instructor->zoom_account_id ?? old('zoom_account_id')) }}"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input class="form--control" name="zoom_client_id"
                                                            value="{{ __(@$instructor->zoom_client_id ?? old('zoom_client_id')) }}"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input class="form--control" name="zoom_secret_id"
                                                            value="{{ __(@$instructor->zoom_secret_id ?? old('zoom_secret_id')) }}"
