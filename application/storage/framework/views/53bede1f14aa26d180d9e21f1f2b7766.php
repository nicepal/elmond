                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="<?php echo app('translator')->get('Enroll in Courses'); ?>" href="<?php echo e(route('admin.users.enroll.courses', $user->id)); ?>"
                                                class="btn btn-sm btn--success">
                                                <i class="las la-graduation-cap text--shadow"></i>
                                            </a>
                                        </td>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <div class="d-flex flex-wrap justify-content-end">
        <a href="<?php echo e(route('admin.users.create.student')); ?>" class="btn btn--primary me-2">
            <i class="las la-plus"></i><?php echo app('translator')->get('Create Student'); ?>
        </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/admin/users/list.blade.php ENDPATH**/ ?>