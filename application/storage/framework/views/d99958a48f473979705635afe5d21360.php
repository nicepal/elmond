<?php if($seo): ?>
    <meta name="title" Content="<?php echo e(isset($seo->course_title) ? $seo->course_title : $general->siteName(__($pageTitle))); ?>">
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(isset($seo->course_title) ? $seo->course_title : $general->siteName($pageTitle)); ?>">
    
    <meta itemprop="name" content="<?php echo e(isset($seo->course_title) ? $seo->course_title : $general->siteName($pageTitle)); ?>">
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/includes/seo.blade.php ENDPATH**/ ?>