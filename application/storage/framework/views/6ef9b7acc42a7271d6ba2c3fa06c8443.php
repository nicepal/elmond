    ...
    <div class="login">
        ...
        <div class="login__body">
            ...
            <form action="<?php echo e(route('admin.login')); ?>" method="POST">
                ...
                <div class="field">
                    <input type="password" name="password" id="admin-password" placeholder="<?php echo app('translator')->get('Password'); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>