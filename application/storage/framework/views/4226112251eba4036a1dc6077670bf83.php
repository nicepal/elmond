                ...
                <div class="header-wrapper">
                    ...
                    <ul class="login d-lg-flex d-none align-items-center gap-3">
                        ...
                        <li class="cart-icon-wrapper">
                            <a href="<?php echo e(route('user.cart.index')); ?>" class="cart-link" id="cart-link">
...
<?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/presets/default/components/header.blade.php ENDPATH**/ ?>