                            ...
                            <div class="login-meta mb-4 d-flex" data-wow-delay="0.5s">
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo e(route('instructor.password.request')); ?>" class="forgot-password"><?php echo app('translator')->get('Forgot Your Password?'); ?></a>
                                    </div>
                                </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/presets/default/instructor/auth/login.blade.php ENDPATH**/ ?>