    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar__menu-header"><?php echo app('translator')->get('Organization Management'); ?></li>
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.organizations.*')); ?>">
                    <a href="<?php echo e(route('admin.organizations.index')); ?>" class="nav-link ">
                        <i class="menu-icon las la-building"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Organizations'); ?></span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.modules.*')); ?>">
                    <a href="<?php echo e(route('admin.modules.index')); ?>" class="nav-link ">
                        <i class="menu-icon las la-cubes"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Modules'); ?></span>
                    </a>
                </li>
                ...
                <li class="sidebar__menu-header"><?php echo app('translator')->get('Coupon Management'); ?></li>
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.coupons.*')); ?>">
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.instructor.ticket.*')); ?>">
                    <a href="<?php echo e(route('admin.instructor.ticket.pending')); ?>" class="nav-link ">
                        <i class="menu-icon las la la-life-ring"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Instructor Support'); ?></span>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/admin/components/sidenav.blade.php ENDPATH**/ ?>