                                ...
                                <div class="base--card">
                                    <form action="<?php echo e(route('user.deposit.insert')); ?>" method="post">
                                        ...
                                        <div class="">
                                                ...
                                                <select class="form-control form--control" name="gateway" required>
                                                    ...
                                                    <?php $__currentLoopData = $gatewayCurrency ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(@$data->method_code); ?>"
                                                            <?php if(old('gateway') == $data->method_code): echo 'selected'; endif; ?> data-gateway="<?php echo e($data); ?>">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group ">
                                                    <input type="number" step="any" name="amount"
                                                        ...
                                                        value="<?php echo e($price); ?>" autocomplete="off"
                                                        required readonly>
                                            ...
                                            <button type="submit"
                                                class="btn--base button w-100 mt-3 p-2"><?php echo app('translator')->get('Submit'); ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/elmond/application/resources/views/presets/default/user/payment/deposit.blade.php ENDPATH**/ ?>