...
// ADD: Public cart routes (guest + auth)
Route::name('user.')->group(function () {
    Route::controller(CartController::class)->prefix('cart')->name('cart.')->middleware('web')->group(function () {
        Route::get('/', 'viewCart')->name('index');
        Route::post('/add/{course_id}', 'addToCart')->name('add');
        Route::post('/remove/{course_id}', 'removeFromCart')->name('remove');
        Route::get('/count', 'getCount')->name('count');
        Route::post('/guest-checkout', 'guestCheckout')->name('guest.checkout');
    });
});

// ADD: Public enroll route (accessible to both guests and authenticated users)
Route::name('user.')->group(function () {
    Route::controller('User\\EnrollController')->name('enroll.')->group(function () {
...
Route::middleware('auth')->name('user.')->group(function () {
    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            // Enroll controller (authenticated routes only)
            Route::controller('EnrollController')->name('enroll.')->group(function () {
                Route::get('enroll-multi', 'enrollMultiple')->name('multi');
            ...
            Route::controller('CartController')->prefix('cart')->name('cart.')->middleware('web')->group(function () {
